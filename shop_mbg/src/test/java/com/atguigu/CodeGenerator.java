...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("F:\\JavaStudy\\workspace\\shop_parent\\shop_core\\shop_seckill\\src\\main\\java");
        globalConfig.setAuthor("GodWei");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://112.74.162.185:3306/shop_seckill?serverTimezone=GMT%2B8");
        ...
        //strategy.setInclude("product_image");//已做
       // strategy.setInclude("base_sale_property");//已做
       // strategy.setInclude("product_sale_property_key","product_sale_property_value");//已做
        //strategy.setInclude("product_spu");//已做
        //strategy.setInclude("base_brand");//已做
       ...
       // strategy.setInclude("base_category_view");//已做
        //strategy.setInclude("user_info","user_address"); //did
//      strategy.setInclude("cart_info","order_detail","order_info","payment_info");//did
      //strategy.setInclude("payment_info");//did
